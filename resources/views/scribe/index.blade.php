    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-register">Users | New</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-products">Products | List</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-products-new">
                                <a href="#endpoints-POSTapi-products-new">Products | New</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-products--id-">
                                <a href="#endpoints-GETapi-products--id-">Products | Show</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-products--id-">
                                <a href="#endpoints-PUTapi-products--id-">Products | Update</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-products--id-">
                                <a href="#endpoints-DELETEapi-products--id-">Products | Delete</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>You can retrieve your token by mading the login in /api/login.</p>

        <h1 id="endpoints">Endpoints</h1>

    

                                <h2 id="endpoints-POSTapi-register">Users | New</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products">Products | List</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Display a listing of products.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-products-new">Products | New</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Store a newly created product in database.</p>

<span id="example-requests-POSTapi-products-new">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/products/new" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-POSTapi-products-new">
</span>
<span id="execution-results-POSTapi-products-new" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-products-new"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-products-new"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-products-new" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-products-new">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-products-new" data-method="POST"
      data-path="api/products/new"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-products-new', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-products-new"
                    onclick="tryItOut('POSTapi-products-new');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-products-new"
                    onclick="cancelTryOut('POSTapi-products-new');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-products-new"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-products-new"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-products-new"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-products-new"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-products-new"
               value="consequatur"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="details"                data-endpoint="POSTapi-products-new"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products--id-">Products | Show</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Display the specified product.</p>
...
<p>The ID of the product. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-products--id-">Products | Update</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Update the specified product in database.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="details"                data-endpoint="PUTapi-products--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-products--id-">Products | Delete</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Remove the specified product from database.</p>
